...
export const ApplicationUserDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="applicationUserDetailsHeading">
          <Translate contentKey="crmApp.applicationUser.detail.title">ApplicationUser</Translate>
        </h2>
